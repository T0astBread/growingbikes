 ...
 */
var setNavBarExtendedState = (extended: boolean, keepDarkBackground?: boolean) =>
{
...
var setDarkenContent = (config: {darken: boolean, zIndex?: number, blockPointerEvents?: boolean, opacity?: number}) =>
{
